...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item \texttt{https://zdgyot.ugic0k.ru/assets/bin.exe}
            \begin{itemize}
                \item download URL
            \end{itemize}
            \item \texttt{GB 29 NWBK 601613 31926819 }
            \begin{itemize}
                \item IBAN number
                \item Swift: \texttt{NWBK}, Account number: \texttt{31926819}, Currency: \texttt{GBP}
            \end{itemize}
            \item \texttt{+12243359185}
            \begin{itemize}
                \item phone number
            \end{itemize}
            \item \texttt{Wallace Breen} is from \texttt{GB}
            \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Perform enrichments on the binary, and domain
...
\begin{frame}
    ...
    \end{itemize}
    \includegraphics[width=1.0\linewidth]{pictures/event.png}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.80\linewidth]{pictures/attribute-bin.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.70\linewidth]{pictures/attribute-ip.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{Case study 1: Scam call}
    \begin{center}
        \includegraphics[width=1.0\linewidth]{pictures/object-url.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{Case study 1: Scam call}
    \begin{center}
        \includegraphics[width=1.0\linewidth]{pictures/object-bankaccount.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.70\linewidth]{pictures/attribute-phone.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{Case study 1: Scam call}
    \begin{center}
        \includegraphics[width=1.0\linewidth]{pictures/object-person.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{Case study 1: Scam call}
    Add relationships to recreate the story
    \includegraphics[width=1.0\linewidth]{pictures/event-graph.png}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \includegraphics[width=1.0\linewidth]{pictures/enrichment.png}
\end{frame}
...
\begin{frame}
    \frametitle{Case study 1: Scam call}
    \includegraphics[width=1.0\linewidth]{pictures/event-tags.png}
\end{frame}
...
\begin{frame}
    ...
    Create a small write-up as an \textit{event report}
    \begin{center}
        \includegraphics[width=0.65\linewidth]{pictures/event-report.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item[] \textbf{Case}: xxxx
        \item[] \textbf{Chronology - 2022-03-24}
        \begin{itemize}
            \item[] \textbf{\small 11:42:43 UTC+0}: 
            \item[] \textbf{\small 11:47:27 UTC+0}: 
            \item[] \textbf{\small 12:06:32 UTC+0}: 
            \item[] \textbf{\small 12:08:18 UTC+0}: 
            \item[] \textbf{\small 12:17:51 UTC+0}: 
            \item[] \textbf{\small 12:25:04 UTC+0}: 
            \item[] \textbf{\small 2022-03-25 08:39:21 UTC+0}: 
        \end{itemize}
    \end{itemize}
\end{frame}
